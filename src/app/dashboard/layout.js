...
export default function DashboardLayout({ children }) {
  ...
  const [openMenus, setOpenMenus] = useState({ userManagement: true }); // track open sections
  ...
  // Menu structure with master and sub-master
  const menuItems = [
      ...
      <div className="flex-1 flex flex-col bg-gray-100">
        ...
        <header className="bg-white shadow-sm px-6 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center gap-5">
            {/* Ad Banner */}
            {/* <div className="hidden md:block bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-4 py-1.5 rounded-full text-sm font-medium shadow-sm">
              🎉 Special Offer: 20% off on all courses!
            </div> */}
            ...
            <div className="relative" ref={profileRef}>
              ...
              >
                <img src={user.avatar} alt={user.name} className="w-10 h-10 rounded-full border-2 border-gray-200 shadow-sm" />
              </button>
                ...
                <div className="absolute right-0 mt-3 w-64 bg-white rounded-2xl shadow-xl border border-gray-100 z-50 overflow-hidden">
                  <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-b">
                    <div className="flex items-center gap-3">
                      <img src={user.avatar} alt={user.name} className="w-12 h-12 rounded-full border-2 border-white shadow" />
                      <div>
                  ...
                  <div className="py-2">
                    ...
                    <Link href="/dashboard/settings" className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition">
                      <svg className="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
